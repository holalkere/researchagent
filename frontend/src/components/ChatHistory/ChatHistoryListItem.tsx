...
import Chatdelete from "../../assets/Chatdelete.svg";
import Chatedit from "../../assets/Chatedit.svg";
        ...
        >
            {edit ? <>
                ...
                <Stack horizontal verticalAlign={'center'} style={{ width: '100%' }}>
                    ...
                    {/* <Stack>
                        <div>
                        <img src={Chatedit} style={{paddingRight:10px}}/>
                            <img src={Chatdelete}/>
                        </div>
                    </Stack> */}
                    {(isSelected || isHovered) && <Stack horizontal horizontalAlign='end'>
                    <img src={Chatedit} style={{paddingRight:'10px'}} onClick={onEdit} onKeyDown={e => e.key === " " ? onEdit() : null}/>
                            <img src={Chatdelete} onClick={toggleDeleteDialog} onKeyDown={e => e.key === " " ? toggleDeleteDialog() : null}/>
                        {/* <IconButton className={`${styles.itemButton} ${styles.customIconColor}`} iconProps={{ iconName: 'Delete' }} title="Delete" onClick={toggleDeleteDialog} onKeyDown={e => e.key === " " ? toggleDeleteDialog() : null}/>
                        <IconButton className={`${styles.itemButton} ${styles.customIconColor}`} iconProps={{ iconName: 'Edit' }} title="Edit" onClick={onEdit} onKeyDown={e => e.key === " " ? onEdit() : null}/>*/}
                    </Stack>} 
                </Stack>
            </>
            }
